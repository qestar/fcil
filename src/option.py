...
def args_parser():
    ...
    parser.add_argument('--num_clients', type=int, default=5, help='initial number of clients')
    parser.add_argument('--local_clients', type=int, default=2, help='number of selected clients each round')
    parser.add_argument('--epochs_global', type=int, default=10, help='total number of global rounds')
