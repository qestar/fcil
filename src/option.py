...
def args_parser():
    ...
    parser.add_argument('--numclass', type=int, default=20, help="number of data classes in the first task")
    ...
    parser.add_argument('--task_size', type=int, default=20, help='number of data classes each task')
    ...
    parser.add_argument('--tasks_global', type=int, default=20, help='total number of tasks')
